  ...
  return (
    <main className="mainStyle">
      ...
      <p className="quizRules">
        Regeln: Start mit 3 Punkten. Richtige Antwort +1 Punkt, Falsche Antwort
        -1 Punkt. Bei 0 ist das Spiel vorbei!
      </p>
          ...
          <>
            <div
              className={`scoreDisplay ${
                score > 2 ? "scoreHigh" : score === 2 ? "scoreMed" : "scoreLow"
              }`}
            >
              Punkte: {score}
            </div>
            ...
            <div className="feedbackContainer">
              {feedback === "correct" && (
                <h2 className="feedbackCorrect">Richtig! (+1)</h2>
              )}
              {feedback === "wrong" && (
